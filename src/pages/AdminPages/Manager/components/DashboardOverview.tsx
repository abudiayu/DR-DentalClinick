  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3">
        <StatCard icon={<Users className="w-4 h-4" />}       label={t('manager.patientsToday')}      value={8}      growth="+12%"  positive color="#6366f1" delay={0}    />
        <StatCard icon={<DollarSign className="w-4 h-4" />}  label={t('manager.todayIncome')}        value={6200}   growth="+8%"   positive color="#10b981" delay={0.05} suffix=" Br" />
        <StatCard icon={<TrendingUp className="w-4 h-4" />}  label={t('manager.monthlyProfit')}      value={30500}  growth="+15%"  positive color="#8b5cf6" delay={0.1}  suffix=" Br" />
        <StatCard icon={<Clock className="w-4 h-4" />}       label={t('manager.pendingPayments')}    value={14800}  growth="-3%"   positive={false} color="#f59e0b" delay={0.15} suffix=" Br" />
        <StatCard icon={<Stethoscope className="w-4 h-4" />} label={t('manager.totalServices')}      value={5}      growth="+1"    positive color="#06b6d4" delay={0.2}  />
        <StatCard icon={<UserCheck className="w-4 h-4" />}   label={t('manager.registeredPatients')} value={168}    growth="+24"   positive color="#ec4899" delay={0.25} />
      </div>
