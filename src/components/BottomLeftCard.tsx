  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        className="hero-join-btn flex items-center bg-white rounded-full pl-1.5 pr-5 py-1.5 gap-2 hover:bg-white/90 transition-colors self-start group cursor-pointer"
      >
        <div className="hero-join-btn-icon bg-[rgba(30,50,90,0.1)] p-1 rounded-full flex items-center justify-center">
          <ArrowUpRight className="w-3.5 h-3.5 text-[rgba(30,50,90,0.9)]" />
        </div>
        <span className="hero-join-btn-label text-[14px] font-normal text-[rgba(30,50,90,0.9)]">{t('hero.joinStaff')}</span>
      </motion.button>
    </motion.div>
  )
}
